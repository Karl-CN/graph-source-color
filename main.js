...
// main.ts
var DEFAULT_SETTINGS2 = __spreadProps(__spreadValues({}, DEFAULT_SETTINGS), {
...
var GraphSourceColorPlugin = class extends import_obsidian3.Plugin {
  ...
  onload() {
    return __async(this, null, function* () {
      ...
      this.app.workspace.onLayoutReady(() => __async(this, null, function* () {
        ...
        yield this.restoreColorsFromGraphJson();
        yield this.loadObsidianColorMap();
  ...
  loadSettings() {
    return __async(this, null, function* () {
      this.settings = Object.assign({}, DEFAULT_SETTINGS2, yield this.loadData());
    });
  }
  saveSettings() {
    return __async(this, null, function* () {
  ...
  migrateSettings() {
    return __async(this, null, function* () {
      ...
      if (migrated) {
        yield this.saveData(loadedData);
        this.settings = Object.assign({}, DEFAULT_SETTINGS2, loadedData);
      }
    });
  }
  restoreColorsFromGraphJson() {
    return __async(this, null, function* () {
      var _a, _b, _c, _d, _e;
      if (!this.sourceDetector)
        return;
      try {
        const existingGroups = (_a = yield this.readExistingColorGroups()) != null ? _a : [];
  ...
  readExistingColorGroups() {
    return __async(this, null, function* () {
      try {
        const adapter = this.app.vault.adapter;
        const graphJsonPath = this.app.vault.configDir + "/graph.json";
        if (!(yield adapter.exists(graphJsonPath)))
          return null;
        const raw = yield adapter.read(graphJsonPath);
  ...
  loadObsidianColorMap() {
    return __async(this, null, function* () {
      var _a, _b, _c;
      const newMap = /* @__PURE__ */ new Map();
      const groups = yield this.readExistingColorGroups();
      if (!groups) {
...
var GraphSourceColorSettingTab = class extends import_obsidian3.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian3.Setting(containerEl).setName("\u542F\u7528\u591A\u8272\u8282\u70B9").setDesc("\u4E3A\u94FE\u63A5\u591A\u4E2A\u6E90\u70B9\u7684\u7B14\u8BB0\u663E\u793A\u591A\u8272\u8282\u70B9").addToggle((toggle) => toggle.setValue(this.plugin.settings.enableMultiColor).onChange((value) => __async(this, null, function* () {
    ...
    treeSelector.onCheckChange = (checkedFolders) => __async(this, null, function* () {
    ...
    for (const folder of this.plugin.settings.sourceFolders) {
      ...
      new import_obsidian3.Setting(containerEl).setName(folder).addColorPicker((picker) => picker.setValue(color).onChange((value) => __async(this, null, function* () {
